...
public class CartCreateRequest  implements java.io.Serializable {
    ...
    private com.amazon.ws.CartCreateRequestItemsItem[] items;
    ...
    public CartCreateRequest(
           ...
           com.amazon.ws.CartCreateRequestItemsItem[] items,
     ...
     * @return items
     */
    public com.amazon.ws.CartCreateRequestItemsItem[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(com.amazon.ws.CartCreateRequestItemsItem[] items) {
        this.items = items;
    }
