...
public class CartModifyRequest  implements java.io.Serializable {
    ...
    private com.amazon.ws.CartModifyRequestItemsItem[] items;
    ...
    public CartModifyRequest(
           ...
           com.amazon.ws.CartModifyRequestItemsItem[] items,
     ...
     * @return items
     */
    public com.amazon.ws.CartModifyRequestItemsItem[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(com.amazon.ws.CartModifyRequestItemsItem[] items) {
        this.items = items;
    }
