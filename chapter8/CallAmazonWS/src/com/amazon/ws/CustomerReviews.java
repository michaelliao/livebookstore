...
public class CustomerReviews  implements java.io.Serializable {
    ...
    private com.amazon.ws.Review[] review;
     ...
     * @return review
     */
    public com.amazon.ws.Review[] getReview() {
        return review;
    }
     ...
     * @param review
     */
    public void setReview(com.amazon.ws.Review[] review) {
        this.review = review;
    }

    public com.amazon.ws.Review getReview(int i) {
        return this.review[i];
    }

    public void setReview(int i, com.amazon.ws.Review _value) {
