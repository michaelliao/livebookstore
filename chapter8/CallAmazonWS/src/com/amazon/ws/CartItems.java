...
public class CartItems  implements java.io.Serializable {
    ...
    private com.amazon.ws.CartItem[] cartItem;
    ...
    public CartItems(
           ...
           com.amazon.ws.CartItem[] cartItem) {
     ...
     * @return cartItem
     */
    public com.amazon.ws.CartItem[] getCartItem() {
        return cartItem;
    }
     ...
     * @param cartItem
     */
    public void setCartItem(com.amazon.ws.CartItem[] cartItem) {
        this.cartItem = cartItem;
    }

    public com.amazon.ws.CartItem getCartItem(int i) {
        return this.cartItem[i];
    }

    public void setCartItem(int i, com.amazon.ws.CartItem _value) {
