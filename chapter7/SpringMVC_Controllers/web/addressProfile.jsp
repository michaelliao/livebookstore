...
public class ViewProfileController extends MultiActionController {
	...
	<tr>
		<td style="padding:6px;"><!-- InstanceBeginEditable name="MainPage" -->
			<p>查看个人资料：<a href="basicProfile.do">基本资料</a> <a href="contactProfile.do">联系方式</a> 详细地址 [<a href="logout.do">注销</a>]</p>
			<table width="377" border="0" cellspacing="0" cellpadding="3">
				<tr>
					<td width="109" align="right">省：</td>
					<td width="256"><c:out value="${province}" /></td>
				</tr>
				<tr>
					<td align="right">市：</td>
